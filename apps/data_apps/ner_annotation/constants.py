...
NER_DATA = [
    ...
    [
        ...
        {"text": " want to improve this figure, while also improving the customer experience. "},
        {"text": "With higher accuracy fraud detection, you can get on with your chips without the hassle. "},
        ...
        {"text": "around the world, helping hundreds of thousands of businesses reduce their fraud loss "},
        {"text": "and increase their revenue. And of course, you will save party people just like you the hassle of "},
    ...
    [
        ...
        {"text": "machine learning to improve forecast accuracy. "},
        ...
        {"text": "the world’s largest company by revenue, to forecast daily sales for the next 28 days. "},
        ...
        {"text": "Together, this robust dataset can be used to improve forecasting accuracy. "},
